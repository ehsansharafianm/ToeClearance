...
public class MainActivity extends AppCompatActivity implements DotDeviceCallback, DotScannerCallback, DotRecordingCallback, DotSyncCallback, DotMeasurementCallback {
    ...
    public void LabelingData(View view){
        ...
        activity6Button = findViewById(R.id.activity6Button);
        activity7Button = findViewById(R.id.activity7Button);
        activity8Button = findViewById(R.id.activity8Button);
        activity9Button = findViewById(R.id.activity9Button);
        homeButton = findViewById(R.id.homeButton);
        ...
        activity6Button.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        packetCounterCofficient = 6000000;
                        activity6Button.setBackgroundColor(Color.parseColor("#05fff8"));
                        break;
                    case MotionEvent.ACTION_UP:
                        packetCounterCofficient = 0;
                        activity6Button.setBackgroundColor(Color.parseColor("#022F43"));
                        break;
                }
                return true;
            }
        });
        activity7Button.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        packetCounterCofficient = 7000000;
                        activity7Button.setBackgroundColor(Color.parseColor("#05fff8"));
                        break;
                    case MotionEvent.ACTION_UP:
                        packetCounterCofficient = 0;
                        activity7Button.setBackgroundColor(Color.parseColor("#022F43"));
                        break;
                }
                return true;
            }
        });
        activity8Button.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        packetCounterCofficient = 8000000;
                        activity8Button.setBackgroundColor(Color.parseColor("#05fff8"));
                        break;
                    case MotionEvent.ACTION_UP:
                        packetCounterCofficient = 0;
                        activity8Button.setBackgroundColor(Color.parseColor("#022F43"));
                        break;
                }
                return true;
            }
        });
        activity9Button.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        packetCounterCofficient = 9000000;
                        activity9Button.setBackgroundColor(Color.parseColor("#05fff8"));
                        break;
                    case MotionEvent.ACTION_UP:
                        packetCounterCofficient = 0;
                        activity9Button.setBackgroundColor(Color.parseColor("#022F43"));
                        break;
                }
                return true;
            }
...
//*//*////*//*////*//*////*//*////*//*////*//*// //*//*// //*//*// //*//*// //*//*// //*//*// //*//*// //*//*// //*//*// //*//*// //*//*//
    ...
    public void fillFields(String address, DotData dotData, double[] eulerAngles){
        ...
        if (address.equals(thigh.MAC)) {
            ...
            thigh.dataOutput[0] = threePlaces.format(eulerAngles[0]);
            ...
            foot.dataOutput[0] = threePlaces.format(eulerAngles[0]);
